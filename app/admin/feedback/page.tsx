      ...
      <div className="ml-96 pl-16 mr-16">
        ...
        <div className="content-section__box">
          ...
          <div className="mt-14">
            ...
            <p className="mb-5">
              To add new feedback, click the "Add New" button. This will
            ...
            <p className="mb-5">
              ...
              column of the table, then select the "View Trainee Feedback"
              option from the dropdown menu. This will redirect you to a page
              where you can view the Trainee Feedback detail.
            </p>
            <div className="flex items-center justify-center my-8">
              <img
                src="/viewtraineefeedback.png"
                alt="admin dashboard"
                className="h-64 w-auto shadow-lg transform transition-transform duration-300 hover:scale-105"
              />
            </div>
